...
const countries = [
  ...
  },
  {
    name: "Japan",
    flag: "jp",
    topUnis: "5 in Top 100",
    tuition: "$5K-$15K/yr",
    living: "$8K-$12K/yr",
    workVisa: "Designated Activities visa up to 1 year",
    workRights: "28hrs/week during term",
    educationRating: 85,
    costRating: 80,
    workRating: 70,
    qolRating: 90,
    highlights: ["Low tuition fees", "MEXT scholarships", "Tech & culture hub"],
    slug: "study-in-japan",
  },
  {
    name: "South Korea",
    flag: "kr",
    topUnis: "3 in Top 100",
    tuition: "$3K-$12K/yr",
    living: "$6K-$10K/yr",
    workVisa: "D-10 Job Seeking visa up to 2 years",
    workRights: "20hrs/week during term",
    educationRating: 82,
    costRating: 85,
    workRating: 72,
    qolRating: 88,
    highlights: ["Affordable education", "KGSP scholarship", "K-culture experience"],
    slug: "study-in-south-korea",
  },
  {
    name: "Europe",
    flag: "eu",
    topUnis: "Many in Top 100",
    tuition: "$0-$20K/yr",
    living: "$8K-$15K/yr",
    workVisa: "Varies by country (up to 18 months)",
    workRights: "Varies by country",
    educationRating: 88,
    costRating: 90,
    workRating: 68,
    qolRating: 91,
    highlights: ["Tuition-free options", "Schengen travel", "Diverse cultures"],
