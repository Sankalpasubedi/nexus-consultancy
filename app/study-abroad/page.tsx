...
const links = [
  {
    icon: "Globe",
    title: "Destinations",
    description: "Compare countries side-by-side — costs, education quality, work opportunities, and more.",
                ...
                <HoverCard>
                  <Link href={l.href} className="block h-full">
                    <div className="bg-white rounded-3xl p-8 border border-gray-100 h-full group relative overflow-hidden">
                      <div className={`absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br ${l.gradient} opacity-10 blur-2xl group-hover:opacity-20 transition rounded-full`} />
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${l.gradient} flex items-center justify-center mb-6 shadow-lg`}>
