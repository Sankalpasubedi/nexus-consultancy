...
const ukData: CountryDataType = {
  ...
  universities: [
    { id: "1", name: "De Montfort University", location: { city: "Leicester", state: "England" }, ranking: { position: 801, type: "Global" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International merit scholarship" } },
    { id: "2", name: "Bath Spa University", location: { city: "Bath", state: "England" }, ranking: { position: 900, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "Vice-Chancellor scholarship" } },
    { id: "3", name: "St Mary's University", location: { city: "Twickenham", state: "England" }, ranking: { position: 940, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "International student bursary" } },
    { id: "4", name: "University of Wales", location: { city: "Cardiff", state: "Wales" }, ranking: { position: 880, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "Wales international fee discount" } },
    { id: "5", name: "The University of Law", location: { city: "London", state: "England" }, ranking: { position: 720, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International bursary" } },
    { id: "6", name: "London South Bank University", location: { city: "London", state: "England" }, ranking: { position: 850, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "Global success scholarship" } },
    { id: "7", name: "Cardiff Metropolitan University", location: { city: "Cardiff", state: "Wales" }, ranking: { position: 760, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International applicant scholarship" } },
    { id: "8", name: "Ulster University", location: { city: "Belfast", state: "Northern Ireland" }, ranking: { position: 559, type: "Global" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International scholarship award" } },
    { id: "9", name: "University of Chester", location: { city: "Chester", state: "England" }, ranking: { position: 870, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "International merit scholarship" } },
    { id: "10", name: "University of Plymouth", location: { city: "Plymouth", state: "England" }, ranking: { position: 571, type: "Global" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International student scholarship" } },
    { id: "11", name: "Birmingham City University", location: { city: "Birmingham", state: "England" }, ranking: { position: 951, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International excellence scholarship" } },
    { id: "12", name: "Liverpool John Moores University", location: { city: "Liverpool", state: "England" }, ranking: { position: 751, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International achievement scholarship" } },
    { id: "13", name: "Oxford International Group Pathways", location: { city: "Oxford", state: "England" }, ranking: { position: 1020, type: "Pathway" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "Pathway tuition bursary" } },
    { id: "14", name: "University of Northampton | UON", location: { city: "Northampton", state: "England" }, ranking: { position: 930, type: "National" }, scholarship: { percentage: 30, accreditedBy: "QAA", description: "International scholarship" } },
    { id: "15", name: "University of Suffolk", location: { city: "Ipswich", state: "England" }, ranking: { position: 975, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "Vice-Chancellor's international award" } },
    { id: "16", name: "UWE Bristol: University of the West of England Bristol", location: { city: "Bristol", state: "England" }, ranking: { position: 741, type: "Global" }, scholarship: { percentage: 30, accreditedBy: "QAA", description: "Chancellor's scholarship" } },
    { id: "17", name: "University of Bedfordshire", location: { city: "Luton", state: "England" }, ranking: { position: 890, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "International merit scholarship" } },
    { id: "18", name: "The University of Sunderland", location: { city: "Sunderland", state: "England" }, ranking: { position: 930, type: "National" }, scholarship: { percentage: 25, accreditedBy: "QAA", description: "Global leaders scholarship" } },
    { id: "19", name: "Brunel University of London", location: { city: "London", state: "England" }, ranking: { position: 343, type: "Global" }, scholarship: { percentage: 35, accreditedBy: "QAA", description: "International excellence award" } },
    { id: "20", name: "Canterbury Christ Chruch University", location: { city: "Canterbury", state: "England" }, ranking: { position: 970, type: "National" }, scholarship: { percentage: 20, accreditedBy: "QAA", description: "International student scholarship" } },
  ],
  whyData: [
