...
const usaData: CountryDataType = {
  ...
  universities: [
    { id: "1", name: "Wichita State University", location: { city: "Wichita", state: "KS" }, ranking: { position: 601, type: "National" }, scholarship: { percentage: 30, accreditedBy: "HLC", description: "International merit scholarship" } },
    { id: "2", name: "Humboldt University", location: { city: "Arcata", state: "CA" }, ranking: { position: 780, type: "National" }, scholarship: { percentage: 20, accreditedBy: "WSCUC", description: "Merit-based tuition support" } },
    { id: "3", name: "California State University Bakersfield", location: { city: "Bakersfield", state: "CA" }, ranking: { position: 701, type: "National" }, scholarship: { percentage: 25, accreditedBy: "WSCUC", description: "CSU international student scholarship" } },
    { id: "4", name: "University of St.Thomas", location: { city: "St. Paul", state: "MN" }, ranking: { position: 530, type: "National" }, scholarship: { percentage: 35, accreditedBy: "HLC", description: "International student grant" } },
    { id: "5", name: "University of Nebraska Lincoln", location: { city: "Lincoln", state: "NE" }, ranking: { position: 410, type: "National" }, scholarship: { percentage: 30, accreditedBy: "HLC", description: "Global Laureate scholarship" } },
    { id: "6", name: "Westcliff University", location: { city: "Irvine", state: "CA" }, ranking: { position: 980, type: "National" }, scholarship: { percentage: 20, accreditedBy: "WSCUC", description: "International learner support scholarship" } },
    { id: "7", name: "Manhattanville University", location: { city: "Purchase", state: "NY" }, ranking: { position: 860, type: "National" }, scholarship: { percentage: 35, accreditedBy: "MSCHE", description: "Presidential international scholarship" } },
    { id: "8", name: "Colorado Mesa University", location: { city: "Grand Junction", state: "CO" }, ranking: { position: 825, type: "National" }, scholarship: { percentage: 25, accreditedBy: "HLC", description: "CMU merit award" } },
    { id: "9", name: "Chadron State College", location: { city: "Chadron", state: "NE" }, ranking: { position: 920, type: "National" }, scholarship: { percentage: 25, accreditedBy: "HLC", description: "International student tuition award" } },
    { id: "10", name: "The University of Tampa", location: { city: "Tampa", state: "FL" }, ranking: { position: 455, type: "National" }, scholarship: { percentage: 30, accreditedBy: "SACSCOC", description: "International scholarship program" } },
  ],
  whyData: [
