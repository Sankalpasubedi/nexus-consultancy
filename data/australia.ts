...
const australiaData: CountryDataType = {
  ...
  universities: [
    {
      id: "1", name: "La Trobe Uni Via Navitas",
      location: { city: "Melbourne", state: "VIC", country: "Australia" },
      ranking: { position: 217, type: "Global" },
      scholarship: { percentage: 25, accreditedBy: "TEQSA", description: "Navitas pathway scholarship and progression support" },
    },
    {
      id: "2", name: "CQ University",
      location: { city: "Sydney", state: "NSW", country: "Australia" },
      ranking: { position: 495, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Student Scholarship" },
    },
    {
      id: "3", name: "James Cook University",
      location: { city: "Townsville", state: "QLD", country: "Australia" },
      ranking: { position: 415, type: "Global" },
      scholarship: { percentage: 25, accreditedBy: "TEQSA", description: "International Excellence Scholarship" },
    },
    {
      id: "4", name: "The University of Newcastle",
      location: { city: "Newcastle", state: "NSW", country: "Australia" },
      ranking: { position: 173, type: "Global" },
      scholarship: { percentage: 25, accreditedBy: "TEQSA", description: "Vice-Chancellor's International Scholarship" },
    },
    {
      id: "5", name: "University of the Sunshine Coast",
      location: { city: "Sippy Downs", state: "QLD", country: "Australia" },
      ranking: { position: 801, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Student Scholarship" },
    },
    {
      id: "6", name: "Charles Sturt University",
      location: { city: "Bathurst", state: "NSW", country: "Australia" },
      ranking: { position: 851, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "Destination Australia support scholarship" },
    },
    {
      id: "7", name: "Western Sydney University",
      location: { city: "Sydney", state: "NSW", country: "Australia" },
      ranking: { position: 375, type: "Global" },
      scholarship: { percentage: 30, accreditedBy: "TEQSA", description: "International Academic Excellence Scholarship" },
    },
    {
      id: "8", name: "Southern Cross University",
      location: { city: "Lismore", state: "NSW", country: "Australia" },
      ranking: { position: 651, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Regional Scholarship" },
    },
    {
      id: "9", name: "Edith Cowan University",
      location: { city: "Perth", state: "WA", country: "Australia" },
      ranking: { position: 529, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Undergraduate Scholarship" },
    },
    {
      id: "10", name: "University of Tasmania",
      location: { city: "Hobart", state: "TAS", country: "Australia" },
      ranking: { position: 307, type: "Global" },
      scholarship: { percentage: 25, accreditedBy: "TEQSA", description: "Tasmanian International Scholarship" },
    },
    {
      id: "11", name: "University of Southern Queensland",
      location: { city: "Toowoomba", state: "QLD", country: "Australia" },
      ranking: { position: 501, type: "Global" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Student Support Scholarship" },
    },
    {
      id: "12", name: "Academies Australasia College",
      location: { city: "Sydney", state: "NSW", country: "Australia" },
      ranking: { position: 1100, type: "National" },
      scholarship: { percentage: 15, accreditedBy: "ASQA", description: "Merit scholarship for pathway and diploma students" },
    },
    {
      id: "13", name: "Kaplan Business School",
      location: { city: "Melbourne", state: "VIC", country: "Australia" },
      ranking: { position: 980, type: "National" },
      scholarship: { percentage: 20, accreditedBy: "TEQSA", description: "International Student Scholarship" },
    },
  ],
  whyData: [
