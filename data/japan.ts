...
const japanData: CountryDataType = {
  ...
  universities: [
    { id: "1", name: "JSL Nippon Academy", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 980, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "International language scholarship" } },
    { id: "2", name: "Saelu Gakuin", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 1020, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Academic progress grant" } },
    { id: "3", name: "Sakura Japanese Language Academy", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 995, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "Japanese study scholarship" } },
    { id: "4", name: "Step World Japanese School", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 1030, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Student support scholarship" } },
    { id: "5", name: "Kyushu Foreign Language Academy", location: { city: "Fukuoka", state: "Fukuoka" }, ranking: { position: 940, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "International language award" } },
    { id: "6", name: "ICLC Japanese Language School", location: { city: "Okinawa", state: "Okinawa" }, ranking: { position: 1015, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Language development scholarship" } },
    { id: "7", name: "Kasuga Japanese Language Academy", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 1040, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Academic merit bursary" } },
    { id: "8", name: "Mt. Fuji Japanese Language School", location: { city: "Fujinomiya", state: "Shizuoka" }, ranking: { position: 960, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "Regional study scholarship" } },
    { id: "9", name: "Tokyo Oji Foreign Language Institute", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 975, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "International learner scholarship" } },
    { id: "10", name: "Tokyo Hope Japanese Language International School", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 1005, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Global student scholarship" } },
    { id: "11", name: "Kobe International Japanese Language Academy", location: { city: "Kobe", state: "Hyogo" }, ranking: { position: 985, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "Kansai language scholarship" } },
    { id: "12", name: "Nagasaki Japanese Language School", location: { city: "Nagasaki", state: "Nagasaki" }, ranking: { position: 1010, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "International student bursary" } },
    { id: "13", name: "Kurashiki Language Academy", location: { city: "Kurashiki", state: "Okayama" }, ranking: { position: 1025, type: "Language" }, scholarship: { percentage: 10, accreditedBy: "MEXT", description: "Language pathway grant" } },
    { id: "14", name: "Japan Tokyo International School", location: { city: "Tokyo", state: "Tokyo" }, ranking: { position: 970, type: "Language" }, scholarship: { percentage: 15, accreditedBy: "MEXT", description: "International progression scholarship" } },
  ],
  whyData: [
