...
export default function NewsSection() {
  ...
  return (
    <section className="group/news py-24 md:py-40 px-4 sm:px-6 lg:px-12 xl:px-16 bg-[#fafaf8]">
      <div className="max-w-[1520px] mx-auto lg:pr-6 xl:pr-10">
        <div className="flex flex-col xl:flex-row gap-8 xl:gap-10 items-stretch">
          ...
          <FadeUp className="hidden xl:flex xl:w-[24%]" delay={0.05}>
            <div className="relative w-full rounded-3xl min-h-[620px] xl:translate-x-20 transform-gpu group-hover/news:translate-x-10 transition-transform duration-500 ease-out">
              <Image
                src="/services/rightimage2.png"
                alt="Student exploring university options"
                fill
                className="object-contain object-center scale-[1.32] group-hover/news:scale-[1.4] transition-transform duration-500 ease-out"
