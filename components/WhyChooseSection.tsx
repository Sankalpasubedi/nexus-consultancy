...
export default function WhyChooseSection() {
  return (
    <section className="group/why py-24 md:py-40 px-4 sm:px-6 lg:px-12 xl:px-16 bg-white">
      <div className="max-w-[1520px] mx-auto lg:pl-6 xl:pl-10">
        ...
        {/* ── Main layout with left visual ── */}
        <div className="flex flex-col xl:flex-row gap-8 xl:gap-10 items-stretch">
          <FadeUp className="hidden xl:flex xl:w-[24%]" delay={0.05}>
            <div className="relative w-full rounded-3xl min-h-[620px] xl:-translate-x-20 transform-gpu group-hover/why:-translate-x-10 transition-transform duration-500 ease-out">
              <Image
                src="/services/leftimage4.png"
                alt="Students planning their international education journey"
                fill
                className="object-contain object-center scale-[1.32] group-hover/why:scale-[1.4] transition-transform duration-500 ease-out"
