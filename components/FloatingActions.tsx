...
/* ================================================================
   ...
   - Very noticeable animations at random intervals (desktop only)
   ================================================================ */

// Animated button with dramatic attention-grabbing animations
function AnimatedButton({
  ...
  animationType: "jump" | "spin" | "shake" | "heartbeat";
  delay: number;
  className: string;
  href: string;
  ariaLabel: string;
  ...
  }, [isMobile, minInterval, maxInterval]);

  // Very dramatic animation keyframes
  const getAnimateProps = () => {
    if (!isAnimating || isMobile) return {};
    
    switch (animationType) {
      case "jump":
        // Big jump up and down with squash/stretch
        return { 
          y: [0, -25, 0, -15, 0, -8, 0],
          scale: [1, 1.2, 0.9, 1.15, 0.95, 1.1, 1],
        };
      case "spin":
        // Full 360 spin with scale
        return { 
          rotate: [0, 360],
          scale: [1, 1.3, 1],
        };
      case "shake":
        // Violent horizontal shake
        return { 
  ...
  return (
    <div className="relative">
      ...
      <motion.a
        ...
        animate={{ opacity: 1, scale: 1, ...getAnimateProps() }}
